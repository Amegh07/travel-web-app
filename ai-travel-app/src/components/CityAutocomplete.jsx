...
import { MapPin, Plane, Loader2, Search, Navigation } from 'lucide-react';
  ...
  useEffect(() => {
    const timer = setTimeout(async () => {
      ...
      try {
        ...
        const airport = data.find(item => item.subType === 'AIRPORT');
        const city = data.find(item => item.subType === 'CITY');
